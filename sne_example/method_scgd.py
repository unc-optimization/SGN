...
def sne_scgd(x0, obj_func, non_lin_func, non_lin_dat, prob_params, alg_params, print_interval=2.0):
    ...
    lr = alg_params.get('lr', 0.01)
    theta = alg_params.get('theta', 1.0)
    ...
    while n_epochs < alg_params['max_epochs']:
        ...
        x_prev = x_cur
        x_hat = x_cur - lr*v_t
        x_next = (1-theta)*x_cur + theta*x_hat
